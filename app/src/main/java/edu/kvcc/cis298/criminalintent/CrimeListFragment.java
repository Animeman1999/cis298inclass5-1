...
public class CrimeListFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //inner class. When the execute method gets called on it, the
        //FetchCrimesTask will start the doInBackgroud method on a
    ...
    //Make an inner class that extends from AsyncTask. The Generic
